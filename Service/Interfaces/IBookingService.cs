...
public interface IBookingService
{
    ...
    Task<BookingResponseDto?>
        UpdateBookingStatusAsync(string bookingId, string staffId, UpdateBookingStatusDto request);
    ...
    // Statistics
    Task<BookingStatisticsDto> GetBookingStatisticsAsync(string? stationId = null, DateTime? fromDate = null,

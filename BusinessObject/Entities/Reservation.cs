...
{
    [Key] [Column("reservation_id")] public string ReservationId { get; set; } = Guid.NewGuid().ToString();
    ...
    [Column("reserved_at")] public DateTime ReservedAt { get; set; } = DateTime.UtcNow;

    [Column("expired_at")] public DateTime ExpiredAt { get; set; }

    // Foreign key navigation properties
    [ForeignKey("StationInventoryId")] public virtual StationInventory StationInventory { get; set; } = null!;
